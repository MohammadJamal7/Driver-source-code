...
// Declare the TextEditingController, but initialize it in onInit
  TextEditingController otpController =
      TextEditingController(); // Use 'late' and remove '.obs' for the controller itself

  @override
  void onInit() {
    super.onInit();
    // Initialize the TextEditingController here
