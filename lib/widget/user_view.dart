...
import '../ui/review/reviews_screen.dart';
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Builder(builder: (_) {
                                      String unit = (distanceType ?? '').toString();
                                      if (Get.locale?.languageCode == 'ar') {
                                        final lower = unit.toLowerCase();
                                        if (lower == 'km') unit = 'كم';
                                        if (lower == 'miles') unit = 'ميل';
                                      }
                                      return Text(
                                        "${(double.parse(distance.toString())).toStringAsFixed(Constant.currencyModel!.decimalDigits!)} $unit",
