...
class DriverUserModel {
  ...
  DriverUserModel(
      ...
      this.totalRides, this.workWhere});
  ...
  DriverUserModel.fromJson(Map<String, dynamic> json) {
    ...
    walletAmount = json['walletAmount']?.toString() ?? "0.0";
    workWhere = json['workWhere'] ?? "";
    coreVehicleInfoLocked = json['coreVehicleInfoLocked'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['coreVehicleInfoLocked'] = coreVehicleInfoLocked;
...
class VehicleInformation {
  ...
  VehicleInformation.fromJson(Map<String, dynamic> json) {
    ...
    acPerKmRate = json['acPerKmRate'].toString();
