  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Withdrawal history".tr,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
        leading: InkWell(
            onTap: () {
              Get.back();
            },
                            ...
                            return snapshot.data!.isEmpty
                                ...
                                : ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      switch (walletTransactionModel.paymentStatus) {
                                        case "pending":
                                          translatedStatus = "Pending".tr;
                                          statusColor = Colors.orange;
                                          break;
                                        case "approved":
                                          translatedStatus = "Approved".tr;
                                          statusColor = Colors.green;
                                          break;
                                        case "rejected":
                                          translatedStatus = "Rejected".tr;
                                          statusColor = Colors.red;
                                          break;
                                        default:
                                          translatedStatus = walletTransactionModel.paymentStatus!.tr;
