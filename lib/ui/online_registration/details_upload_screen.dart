                                ...
                                Visibility(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text("Front Side of".tr + "${Constant.localizationTitle(controller.documentModel.value.title).tr}", style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600)),
                                        const SizedBox(
                                          height: 10,
                                        ),
                                ...
                                Visibility(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text("Back side of".tr+ "${Constant.localizationTitle(controller.documentModel.value.title).tr}", style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600)),
                                        const SizedBox(
                                          height: 10,
                                        ),
