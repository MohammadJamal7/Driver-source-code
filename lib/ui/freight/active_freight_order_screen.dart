...
import '../../controller/freight_controller.dart';
import '../../utils/ride_utils.dart';

class ActiveFreightOrderScreen extends StatefulWidget {
  const ActiveFreightOrderScreen({Key? key}) : super(key: key);

  @override
  State<ActiveFreightOrderScreen> createState() => _ActiveFreightOrderScreenState();
}

class _ActiveFreightOrderScreenState extends State<ActiveFreightOrderScreen> {
