  ...
  _sendMessage(String message, Url? url, String videoThumbnail, String messageType) async {
    ...
    if (url != null) {
      if (url.mime.contains('image')) {
        ...
        conversationModel.message = "Sent an Video".tr;
      } else if (url.mime.contains('audio')) {
        conversationModel.message = "Sent a voice message".tr;
      }
    }
    ...
    SendNotification.sendOneNotification(
        title: "${widget.driverName} ${messageType == "image" ? messageType == "video" ? "sent video to you".tr : "sent image to you".tr : "sent message to you".tr}",
