...
class OrderIntercityScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Ensure HomeIntercityController is initialized
    Get.put(HomeIntercityController(), permanent: true);
                          ...
                          : StreamBuilder<QuerySnapshot>(
                              ...
                              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                                ...
                                final docs = snapshot.data!.docs.toList()
                                  ..sort((a, b) {
                                    final ad = (a.data() as Map<String, dynamic>)["createdDate"];
                                    final bd = (b.data() as Map<String, dynamic>)["createdDate"];
                                    // Firestore Timestamp has compareTo
                                ...
                                return docs.isEmpty
                                    ...
                                    : ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          InterCityOrderModel orderModel = InterCityOrderModel.fromJson(docs[index].data() as Map<String, dynamic>);
                                          print(controller.paymentModel.value.cash!.name.toString());
                                          print(orderModel.paymentType.toString());
                                          print(orderModel.paymentStatus);
                                          return InkWell(
                                            onTap: () {
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Visibility(
                                                          visible:
                                                              controller.paymentModel.value.cash!.name == "Cash" && orderModel.paymentStatus == false,
                                                          child: ButtonThem.buildButton(
                                                            ...
                                                            onPress: () async {
                                                              ...
                                                              FireStoreUtils.updateDriverRides();
