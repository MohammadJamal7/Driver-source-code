        ...
        builder: (controller) {
          return StreamBuilder<QuerySnapshot>(
            ...
            builder:
              ...
              // Filter out cancelled orders in app code
              final acceptedOrders = snapshot.data!.docs.where((doc) {
                final data = doc.data() as Map<String, dynamic>;
                final status = data['status'];
                return status != Constant.rideCanceled;
              }).toList();
              
              hasData = acceptedOrders.isEmpty;
              if (!hasData) {
