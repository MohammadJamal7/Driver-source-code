...
class ActiveIntercityOrderScreen extends StatefulWidget {
  const ActiveIntercityOrderScreen({Key? key}) : super(key: key);

  @override
  State<ActiveIntercityOrderScreen> createState() => _ActiveIntercityOrderScreenState();
}

class _ActiveIntercityOrderScreenState extends State<ActiveIntercityOrderScreen> {
                    ...
                    child: Padding(
                      ...
                      child: StreamBuilder<QuerySnapshot>(
                        stream: FirebaseFirestore.instance
                            ...
                            .where('status', whereIn: [Constant.rideInProgress, Constant.rideActive, Constant.rideHoldAccepted])
                            .snapshots(),
                                                                    ...
                                                                    return Row(
                                                                      children: [
                                                                        orderModel.intercityServiceId == "647f350983ba2"
                                                                            ? const SizedBox()
                                                                            : Text(" ${"Person".tr} ${orderModel.numberOfPassenger} ".tr, style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 18)),
                                                                        Text("${"For".tr} ${Constant.amountShow(amount: driverIdAcceptReject.offerAmount.toString())}",
